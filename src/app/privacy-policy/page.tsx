		...
		<div className="w-full flex justify-center my-10">
			<div className="w-4/5 flex flex-col gap-y-5">
				<h2 className="text-2xl font-medium">
					Privacy Policy for Aténas Fraternity Air Hostess Academy
				</h2>
				<p>
					At Aténas Fraternity Air Hostess Academy, accessible from
					https://atenas.in/, one of our main priorities is the privacy of our
					visitors. This Privacy Policy document contains types of information
					that is collected and recorded by Aténas Fraternity Air Hostess
					Academy and how we use it. If you have additional questions or require
					...
					they shared and/or collect in Aténas Fraternity Air Hostess Academy.
				...
				<p>
					Aténas Fraternity Air Hostess Academy follows a standard procedure of
				...
				<p>
					...
					advertising partners of Aténas Fraternity Air Hostess Academy.
					Third-party ad servers or ad networks uses technologies like cookies,
					JavaScript, or Web Beacons that are used in their respective
					advertisements and links that appear on Aténas Fraternity Air Hostess
					Academy, which are sent directly to users’ browser. They automatically
					...
					visit. Note that Aténas Fraternity Air Hostess Academy has no access
				...
				<p>
					Aténas Fraternity Air Hostess Academy’s Privacy Policy does not apply
				...
				<h2 className="text-2xl font-medium">GDPR Data Protection Rights</h2>
				<p>
				...
				<p>
					...
					participate in, and/or monitor and guide their online activity. Aténas
					Fraternity Air Hostess Academy does not knowingly collect any Personal
				...
				<p>
					...
					not hesitate to contact us. Email: info@atenas.in Phone:
					+91-8422849985
				</p>
			</div>
		</div>
